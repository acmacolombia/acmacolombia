...
// /** */
// export const getPermalink = (slug = '', type = 'page', language): string => {
//   let permalink: string;
...
// /** */
// export const getHomePermalink = (language): string => getPermalink('/', 'page', language);

// /** */
// export const getBlogPermalink = (language): string => getPermalink(BLOG_BASE, 'page', language);

// /** */
// export const getAsset = (path: string, language): string =>
//   '/' +
//   [BASE_PATHNAME, language, path]
//     .map((el) => trimSlash(el))
//     .filter((el) => !!el)
//     .join('/');
